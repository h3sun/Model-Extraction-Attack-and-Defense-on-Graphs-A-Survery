...
def attack1(dataset_name, attack_node_arg, cuda):
    ...
    attack_features = features[attack_nodes]
    ...
    sub_g_b = nx.from_numpy_array(np.asmatrix(g.adjacency_matrix().to_dense()))
    ...
    # =============================================================================
        ...
        acc2 = evaluate(net, sub_g_b, features,
...
# Final one:0.175796812749004Fiderity: 0.3341633466135458
