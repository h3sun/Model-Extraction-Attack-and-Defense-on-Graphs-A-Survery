...
def attack3(dataset_name, attack_node_arg, cuda):
    ...
    fileObject = open('./data/attack3_shadow_graph/' +
                      dataset_name + '/target_graph_index.txt', 'r')
    ...
    sub_graph_index_a = []
    fileObject = open('./data/attack3_shadow_graph/' + dataset_name +
    ...
    attack_node = []
    while len(attack_node) < attack_node_arg * node_number:
        print("attack_node_org is: ", attack_node_arg)
...
# 0.666403785488959 fedility: 0.2421135646687697
